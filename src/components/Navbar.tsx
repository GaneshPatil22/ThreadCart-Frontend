              ...
              <div className="hidden md:flex items-center space-x-4">
                {userEmail ? (
                  <>
                    ...
                    <Link
                      to="/gallery"
                      className="flex items-center gap-1.5 bg-gray-700 text-white px-3 py-1.5 rounded-lg hover:bg-gray-600 transition text-sm font-medium"
                    >
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-3 pb-3 border-t border-gray-700 pt-3">
              <div className="flex flex-col space-y-3">
                ...
                <Link
                  to="/gallery"
                  className="flex items-center gap-2 bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition font-medium w-full justify-center"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
